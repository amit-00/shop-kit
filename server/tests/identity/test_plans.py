...
PLAN_A_1 = {"code": "plan_a", "name": "Plan A", "description": "Plan A", "unit_amount": 100, "currency": "USD", "interval": "month"}
# PLAN_A_2 = Plan(code="plan_a", name="Plan A", description="Plan A", unit_amount=200, currency="USD", interval="month")
PLAN_A_2 = {"code": "plan_a", "name": "Plan A", "description": "Plan A", "unit_amount": 200, "currency": "USD", "interval": "month"}
# PLAN_B_1 = Plan(code="plan_b", name="Plan B", description="Plan B", unit_amount=200, currency="USD", interval="month")
PLAN_B_1 = {"code": "plan_b", "name": "Plan B", "description": "Plan B", "unit_amount": 200, "currency": "USD", "interval": "month"}
...
@pytest.mark.parametrize(
    ...
    [
        ({"plan_a": PLAN_A_1}, {"plan_a": PLAN_A_1}, False, [], [], []),
        ({"plan_a": PLAN_A_1}, {"plan_a": PLAN_A_1, "plan_b": PLAN_B_1}, False, [PLAN_B_1], [], []),
        ({"plan_a": PLAN_A_1}, {"plan_a": PLAN_A_2}, False, [], [PLAN_A_2], []),
        ({"plan_a": PLAN_A_1}, {"plan_b": PLAN_B_1}, False, [PLAN_B_1], [], [PLAN_A_1]),
        ({"plan_a": PLAN_A_1, "plan_b": PLAN_B_1}, {"plan_a": PLAN_A_2}, False, [], [PLAN_A_2], [PLAN_B_1]),
        ({"plan_a": PLAN_A_1}, {"plan_b": PLAN_B_1}, True, [PLAN_B_1], [], []),
        ({"plan_a": PLAN_A_1, "plan_b": PLAN_B_1}, {"plan_a": PLAN_A_2}, True, [], [PLAN_A_2], []),
    ],
...
def test_compute_plan_changes(existing_plans, desired_plans, no_delete, expected_create, expected_update, expected_delete):
    existing_plans = {code: plan_from_dict(plan) for code, plan in existing_plans.items()}
    expected_create = [plan_from_dict(plan) for plan in expected_create]
    expected_update = [plan_from_dict(plan) for plan in expected_update]
    expected_delete = [plan_from_dict(plan) for plan in expected_delete]
